...
<head>
    ...
    <link rel="stylesheet" href="styles/demostyle1.css">
    <link rel="stylesheet" href="styles/demostyle2.css">
...
<body>
  ...
  <script type="text/javascript" src="styles/jquery.orgchart.js"></script>
  <script type="text/javascript" src="styles/demoscripts.js"></script>
  </body>
</html>