		...
		<div id="page-wrapper">
			...
			<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
				...
				<ol class="breadcrumb page-breadcrumb pull-right">
					<li><i class="fa fa-home"></i>&nbsp;<a ui-sref="profilesView">Profiles</a></li>
				</ol>
				<div class="clearfix"></div>
			</div>
								...
								<div id="demo" class="box jplist mal">
									...
									<div class="jplist-panel box panel-top">
										...
										<div class="col-lg-12 mbl">
											...
											<!-- Video Brief Status drop down filter -->
											<div class="jplist-drop-down" style="width: 180px;"
												data-control-type="filter-drop-down"
												data-control-name="uservideostatus-selector-filter"
												data-control-action="filter">
												<ul>
													<li><span data-path="default">Filter by Video
															Status</span></li>
													<li><span data-path=.VideoAvailable>Video
															Available</span></li>
													<li><span data-path=.VideoNA>Video Not
															Available</span></li>
												</ul>
											</div>
										</div>
										<div class="col-lg-12 mbl">
											<div class="text-filter-box">
												...
												<i class="fa fa-search  jplist-icon"></i> <input
													...
													value="" placeholder="Filter by User's Name"
											...
											<div class="text-filter-box">
												...
												<i class="fa fa-search  jplist-icon"></i> <input
													...
													value="" placeholder="Filter by User's Location (City)"
													data-control-type="textbox"
											...
											<div class="text-filter-box">
												...
												<i class="fa fa-search  jplist-icon"></i> <input
													...
													value="" placeholder="Filter by User's Job-Title"
													data-control-type="textbox"
											...
											<div class="text-filter-box">
												...
												<i class="fa fa-search  jplist-icon"></i> <input
													...
													value="" placeholder="Filter by User's Company"
													data-control-type="textbox"
...
<script src="script/profilesview.js"></script>
